...
T = TypeVar("T", bound="BillingRecordsItem")


@_attrs_define
class BillingRecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billing_records_item.additional_properties = d
        return billing_records_item
