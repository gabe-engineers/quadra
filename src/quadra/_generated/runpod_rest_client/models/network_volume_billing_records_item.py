...
T = TypeVar("T", bound="NetworkVolumeBillingRecordsItem")


@_attrs_define
class NetworkVolumeBillingRecordsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_volume_billing_records_item = cls(
            amount=amount,
        ...
        network_volume_billing_records_item.additional_properties = d
        return network_volume_billing_records_item
