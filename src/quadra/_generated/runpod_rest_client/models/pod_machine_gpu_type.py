...
T = TypeVar("T", bound="PodMachineGpuType")


@_attrs_define
class PodMachineGpuType:
    """
    Attributes:
        id (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pod_machine_gpu_type.additional_properties = d
        return pod_machine_gpu_type
