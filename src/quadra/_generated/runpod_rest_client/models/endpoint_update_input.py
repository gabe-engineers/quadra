...
from ..models.endpoint_update_input_allowed_cuda_versions_item import EndpointUpdateInputAllowedCudaVersionsItem
from ..models.endpoint_update_input_cpu_flavor_ids_item import EndpointUpdateInputCpuFlavorIdsItem
from ..models.endpoint_update_input_data_center_ids_item import EndpointUpdateInputDataCenterIdsItem
from ..models.endpoint_update_input_gpu_type_ids_item import EndpointUpdateInputGpuTypeIdsItem
from ..models.endpoint_update_input_min_cuda_version import EndpointUpdateInputMinCudaVersion
from ..models.endpoint_update_input_scaler_type import EndpointUpdateInputScalerType
from ..types import UNSET, Unset

T = TypeVar("T", bound="EndpointUpdateInput")
...
class EndpointUpdateInput:
    ...
    Attributes:
        allowed_cuda_versions (list[EndpointUpdateInputAllowedCudaVersionsItem] | Unset): If the created Serverless
            endpoint is a GPU endpoint, a list of acceptable CUDA versions on the created workers. If not set, any CUDA
            version is acceptable.
        cpu_flavor_ids (list[EndpointUpdateInputCpuFlavorIdsItem] | Unset): If the created Serverless endpoint is a CPU
        ...
        data_center_ids (list[EndpointUpdateInputDataCenterIdsItem] | Unset): A list of Runpod data center IDs where
        ...
        gpu_type_ids (list[EndpointUpdateInputGpuTypeIdsItem] | Unset): If the created Serverless endpoint is a GPU
        ...
        min_cuda_version (EndpointUpdateInputMinCudaVersion | Unset): If the created Serverless endpoint is a GPU
        ...
        scaler_type (EndpointUpdateInputScalerType | Unset): The method used to scale up workers on the created
            ...
            EndpointUpdateInputScalerType.QUEUE_DELAY.
        scaler_value (int | Unset): If the endpoint scalerType is QUEUE_DELAY, the number of seconds a request can
            ...
            Default: 4.
        template_id (str | Unset): The unique string identifying the template used to create the Serverless endpoint.
            Example: 30zmvf89kd.
    ...
    allowed_cuda_versions: list[EndpointUpdateInputAllowedCudaVersionsItem] | Unset = UNSET
    cpu_flavor_ids: list[EndpointUpdateInputCpuFlavorIdsItem] | Unset = UNSET
    data_center_ids: list[EndpointUpdateInputDataCenterIdsItem] | Unset = UNSET
    execution_timeout_ms: int | Unset = UNSET
    flashboot: bool | Unset = UNSET
    gpu_count: int | Unset = 1
    gpu_type_ids: list[EndpointUpdateInputGpuTypeIdsItem] | Unset = UNSET
    idle_timeout: int | Unset = 5
    min_cuda_version: EndpointUpdateInputMinCudaVersion | Unset = UNSET
    name: str | Unset = UNSET
    network_volume_id: str | Unset = UNSET
    network_volume_ids: list[str] | Unset = UNSET
    scaler_type: EndpointUpdateInputScalerType | Unset = EndpointUpdateInputScalerType.QUEUE_DELAY
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _allowed_cuda_versions is not UNSET:
            ...
            for allowed_cuda_versions_item_data in _allowed_cuda_versions:
                allowed_cuda_versions_item = EndpointUpdateInputAllowedCudaVersionsItem(allowed_cuda_versions_item_data)
        ...
        if _cpu_flavor_ids is not UNSET:
            ...
            for cpu_flavor_ids_item_data in _cpu_flavor_ids:
                cpu_flavor_ids_item = EndpointUpdateInputCpuFlavorIdsItem(cpu_flavor_ids_item_data)
        ...
        if _data_center_ids is not UNSET:
            ...
            for data_center_ids_item_data in _data_center_ids:
                data_center_ids_item = EndpointUpdateInputDataCenterIdsItem(data_center_ids_item_data)
        ...
        if _gpu_type_ids is not UNSET:
            ...
            for gpu_type_ids_item_data in _gpu_type_ids:
                gpu_type_ids_item = EndpointUpdateInputGpuTypeIdsItem(gpu_type_ids_item_data)
        ...
        min_cuda_version: EndpointUpdateInputMinCudaVersion | Unset
        if isinstance(_min_cuda_version, Unset):
            min_cuda_version = UNSET
        else:
            min_cuda_version = EndpointUpdateInputMinCudaVersion(_min_cuda_version)
        ...
        scaler_type: EndpointUpdateInputScalerType | Unset
        if isinstance(_scaler_type, Unset):
            scaler_type = UNSET
        else:
            scaler_type = EndpointUpdateInputScalerType(_scaler_type)
        ...
        endpoint_update_input.additional_properties = d
        return endpoint_update_input
