...
T = TypeVar("T", bound="NetworkVolumesItem")


@_attrs_define
class NetworkVolumesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        network_volumes_item.additional_properties = d
        return network_volumes_item
