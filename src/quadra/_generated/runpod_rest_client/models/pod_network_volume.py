...
T = TypeVar("T", bound="PodNetworkVolume")


@_attrs_define
class PodNetworkVolume:
    """If a network volume is attached to a Pod, information about the network volume (see [network volume
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pod_network_volume.additional_properties = d
        return pod_network_volume
