...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | list[Template] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for componentsschemas_templates_item_data in _response_200:
            componentsschemas_templates_item = Template.from_dict(componentsschemas_templates_item_data)

            response_200.append(componentsschemas_templates_item)
