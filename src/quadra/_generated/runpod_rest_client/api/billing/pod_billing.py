...
from ...models.pod_billing_bucket_size import PodBillingBucketSize
from ...models.pod_billing_gpu_type_id import PodBillingGpuTypeId
from ...models.pod_billing_grouping import PodBillingGrouping
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    bucket_size: PodBillingBucketSize | Unset = PodBillingBucketSize.DAY,
    end_time: datetime.datetime | Unset = UNSET,
    gpu_type_id: PodBillingGpuTypeId | Unset = UNSET,
    grouping: PodBillingGrouping | Unset = PodBillingGrouping.GPUTYPEID,
    ...
    json_gpu_type_id: str | Unset = UNSET
    if not isinstance(gpu_type_id, Unset):
        json_gpu_type_id = gpu_type_id.value
...
def sync_detailed(
    *,
    ...
    Args:
        bucket_size (PodBillingBucketSize | Unset): The length of each billing time bucket. The
            billing time bucket is the time range over which each billing record is aggregated.
            Default: PodBillingBucketSize.DAY.
        end_time (datetime.datetime | Unset): The end date of the billing period to retrieve.
            Example: 2023-01-31T23:59:59Z.
        gpu_type_id (PodBillingGpuTypeId | Unset): Filter to Pods with the provided GPU type
            attached. Example: NVIDIA GeForce RTX 4090.
        grouping (PodBillingGrouping | Unset): Group the billing records by the provided field.
            Default: PodBillingGrouping.GPUTYPEID.
        pod_id (str | Unset): Filter to a specific Pod. Example: xedezhzb9la3ye.
